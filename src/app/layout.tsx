          ...
          <header className="bg-[var(--surface)] shadow-1 border-b border-[var(--border)]">
            <nav className="max-w-6xl mx-auto flex gap-8 p-6 items-center">
              ...
              <div className="flex gap-2 ml-auto">
                ...
                <a href="/auth/signin" className="flex items-center gap-2 px-4 py-3 rounded-lg bg-[var(--accent)] text-[var(--accent-contrast)] font-medium text-sm shadow-2 hover:shadow-3 transition-all duration-200">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
