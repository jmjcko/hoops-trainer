...
export default function Home() {
  ...
  useEffect(() => {
    // Simulate fetching basketball news and training content
    ...
    // Shuffle the content to show random videos
    const shuffledContent = channelContent.sort(() => Math.random() - 0.5).slice(0, 6);

    setTimeout(() => {
      setNews(shuffledContent);
      setLoading(false);
    }, 1000);
  }, []);
