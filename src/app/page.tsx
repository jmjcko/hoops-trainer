...
// Helper function to generate YouTube embed URLs based on content
function getYouTubeEmbedUrl(title: string): string {
  // Map training topics to popular YouTube video IDs from basketball channels
  const videoMap: { [key: string]: string } = {
    "Ball Handling": "dQw4w9WgXcQ", // Example video ID
    "Shooting": "jNQXAC9IVRw", // Example video ID  
    "Defense": "M7lc1UVf-VE", // Example video ID
    "Conditioning": "YQHsXMglC9A", // Example video ID
    "Youth": "kJQP7kiw5Fk", // Example video ID
    "Game Situation": "9bZkp7q19f0" // Example video ID
  };
  
  // Find matching video based on title keywords
  for (const [keyword, videoId] of Object.entries(videoMap)) {
    ...
    <div className="max-w-6xl mx-auto py-12 space-y-12">
                ...
                <div className="w-full h-48 bg-black/10 relative">
                  {item.category.includes("YouTube") ? (
                    <iframe 
                      ...
                      src={getYouTubeEmbedUrl(item.title)}
                      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
                      allowFullScreen
                    />
                  ) : item.category.includes("Instagram") ? (
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-[var(--surface)] shadow-1 rounded-lg overflow-hidden hover:shadow-2 transition-all duration-200">
